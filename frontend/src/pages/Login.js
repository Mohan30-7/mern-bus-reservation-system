      ...
      >
        ...
        <form onSubmit={handleLogin}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '20px', marginTop: '-5px' }}>
            <Link to="/forgot-password" style={{ color: '#e53935', fontSize: '14px', textDecoration: 'none', fontWeight: '500' }}>Forgot password?</Link>
          </div>
        ...
        <div style={{ marginTop: 20 }}>
          <p style={{ color: "#666", fontSize: "15px", margin: 0 }}>
            New user?{" "}
            <Link to="/signup" style={{ color: "#e53935", fontWeight: "bold", textDecoration: 'none' }}>
              Sign up
            </Link>
          </p>
        </div>
